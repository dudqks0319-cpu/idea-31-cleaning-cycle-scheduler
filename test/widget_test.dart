...
import 'package:app_31_cleaning_cycle_scheduler/app.dart';
import 'package:app_31_cleaning_cycle_scheduler/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('세탁 청소 주기 스케줄러'), findsWidgets);
